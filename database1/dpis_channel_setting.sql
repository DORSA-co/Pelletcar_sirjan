...
CREATE TABLE `channel_setting` (
  ...
  `ch_sensor1` double DEFAULT '2',
  `ch_sensor2` double DEFAULT '4',
  `ch_sensor3` double DEFAULT '6',
  `ch_sw_sensor1` double DEFAULT '0',
  `ch_sw_sensor2` double DEFAULT '1',
  PRIMARY KEY (`id`)
...
INSERT INTO `channel_setting` VALUES (24,2,4,6,0,1),(25,2,4,6,0,1);
